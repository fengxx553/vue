    ...
    <div>
        <el-form class="form" label-width="85px">
            ...
            <el-form-item label="店铺分类">
                <el-cascader v-model="shoplistvalue" :options="shoplist" :props="{
                    expandTrigger: 'hover',
                    value: 'name',
                    label: 'name',
            ...
            <el-form-item label="配送费">
                <el-input-number v-model="form.float_delivery_fee" :min="0" :max="2000"></el-input-number>
            </el-form-item>
            <el-form-item label="起送价">
                <el-input-number v-model="form.float_minimum_order_amount" :min="0" :max="2000"></el-input-number>
            </el-form-item>
                ...
                <el-upload class="avatar-uploader" action="https://elm.cangdu.org/v1/addimg/shop" :show-file-list="false"
                    :on-success="
                        (response, file, fileList) =>
                            handleAvatarSuccess(response, file, fileList, 1)" :before-upload="beforeAvatarUpload">
            ...
            <el-form-item label="上传营业执照">
                <el-upload class="avatar-uploader" action="https://elm.cangdu.org/v1/addimg/shop" :show-file-list="false"
                    ...
                    <img v-if="form.business_license_image"
                        :src="`https://elm.cangdu.org/img/${form.business_license_image}`" class="avatar" />
                    <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                </el-upload>
            </el-form-item>
            <el-form-item label="上传餐饮服务许可证">
                <el-upload class="avatar-uploader" action="https://elm.cangdu.org/v1/addimg/shop" :show-file-list="false"
                    ...
                    " :before-upload="beforeAvatarUpload">
                    <img v-if="form.catering_service_license_image" :src="
                        `https://elm.cangdu.org/img/${form.catering_service_license_image}`
                    " class="avatar" />
                    <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                </el-upload>
            </el-form-item>
            ...
            <el-table :data="optionstab">
                ...
                <el-table-column label="操作">
                    <template #default="{ row, $index }">
                        <el-button type="danger" @click="deletetab(row, $index)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
